  ...
  return (
    <span className="flex items-center gap-0.5">
      ...
      {Array.from({ length: empty }).map((_, i) => (
        <Star key={`e${i}`} className="h-4 w-4 fill-slate-200 text-slate-300" />
      ))}
    ...
    <div className="overflow-hidden rounded-xl border border-slate-200 bg-slate-50">
      ...
      <div className="grid grid-cols-3 border-b border-slate-200">
        ...
        <div className="border-l border-slate-200 px-4 py-3 text-center">
          <span className="text-sm font-bold italic text-slate-800">{p.yourBrand}.</span>
        </div>

        {/* Winner brand */}
        <div className="border-l border-slate-200 px-4 py-3 text-center">
          <div className="flex flex-col items-center gap-1">
            <span className="text-sm font-semibold text-slate-700">{p.winnerBrand}</span>
      ...
      <div className="grid grid-cols-3 border-b border-slate-200">
        ...
        <div className="border-l border-slate-200 px-4 py-3 text-sm font-medium text-slate-700">{p.winnerPrice}</div>
      </div>
      ...
      <div className="grid grid-cols-3 border-b border-slate-200">
        ...
        <div className="border-l border-slate-200 px-4 py-3 text-sm text-slate-600">{p.winnerAvailability}</div>
      </div>
      ...
      <div className="grid grid-cols-3 border-b border-slate-200">
        ...
        <div className="border-l border-slate-200 px-4 py-3"><Stars rating={p.winnerRating} /></div>
      </div>
