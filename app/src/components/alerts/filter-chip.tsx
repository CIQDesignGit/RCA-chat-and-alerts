...
// ── SelectedFilterChip: "Shark ×" — violet filled, used for active brand/category
...
export function SelectedFilterChip({ label, onRemove }: SelectedFilterChipProps) {
  return (
    <span className="flex items-center gap-1.5 rounded-full bg-violet-100 px-3.5 py-1.5 text-sm font-semibold text-violet-700">
      {label}
      <button
        onClick={onRemove}
...
// ── SkuListChip: "📦 SKU List (16) ▾" — outlined pill with Package icon ───────
